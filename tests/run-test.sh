...
cp -R ~/GitHub/ansible-role-dot-net-developer /tmp/roles/kurron.dot-net-developer
...
CMD="docker run --env DISPLAY=unix${DISPLAY} \
                --env HOME=${HOME_DIR} \
                --env RIDER_JDK=/usr/lib/jvm/azul-jdk-8 \
                ...
                kurron/ansible-role-dot-net-developer:latest bash"
echo $CMD
$CMD
